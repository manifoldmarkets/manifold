...
exports.backupDb = exports.backupDbCore = void 0;
const functions = require("firebase-functions");
const firestore = require("@google-cloud/firestore");
const backupDbCore = async (client, project, bucket) => {
...
exports.backupDbCore = backupDbCore;
exports.backupDb = functions.pubsub
    ...
    try {
        ...
        const responses = await (0, exports.backupDbCore)(client, project, 'manifold-firestore-backup');
