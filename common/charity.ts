...
type CharityTag = 'Featured' | typeof mainTags[number]
...
export const charities: Charity[] = [
  {
    ...
    tags: ['Featured', 'Health'] as CharityTag[],
  },
  {
    name: 'QURI',
    ...
    tags: ['Featured', 'Information'] as CharityTag[],
  },
  {
    ...
    tags: ['Featured', 'Global Crisis'] as CharityTag[],
  },
  {
    ...
    tags: ['Meta', 'Health'] as CharityTag[],
  },
  {
    name: 'ARC',
...
Future plans: We expect to focus on similar theoretical problems in alignment until we either become more pessimistic about tractability or ARC grows enough to branch out into other areas. Over the long term we are likely to work on a combination of theoretical and empirical alignment research, collaborations with industry labs, alignment forecasting, and ML deployment policy.`,
    tags: ['Global Crisis'] as CharityTag[],
  },
  {
    name: 'Give Directly',
  ...
  },
  {
    ...
    tags: ['Animal Welfare', 'Information'] as CharityTag[],
  },
  {
    ...
    tags: ['Animal Welfare'] as CharityTag[],
  },
  {
  ...
  },
  {
    ...
    tags: ['Health', 'Poverty'] as CharityTag[],
  },
  {
    name: 'SCI foundation',
  ...
  },
  {
    ...
    tags: ['Information'] as CharityTag[],
  },
  {
  ...
  },
  {
    ...
    tags: ['Global Crisis', 'Policy'] as CharityTag[],
  },
  {
    name: 'ProPublica',
  ...
  },
  {
    ...
    tags: ['Health', 'Policy', 'Global Crisis'] as CharityTag[],
  },
  {
    name: 'ALLFED',
