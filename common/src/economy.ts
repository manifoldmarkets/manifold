...
export const BOOST_COST_MANA = 25000
export const DEV_BOOST_STRIPE_PRICE_ID = 'price_1QwAlbGdoFKoCJW7NY75Q8Ei'
export const PROD_BOOST_STRIPE_PRICE_ID = 'price_1QwAl2GdoFKoCJW7NKKIHLiJ'
export const BOOST_COST_CASH = 250
