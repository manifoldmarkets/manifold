    ...
    props: z
      .object({
        data: z.object({
          ...
          midpoints: z.array(z.number().finite()).optional(),
          shouldAnswersSumToOne: z.boolean().optional(),
          addAnswersMode: z
            .enum(['DISABLED', 'ONLY_CREATOR', 'ANYONE'])
            .optional(),
          probability: z.number().finite().optional(),
          neverCloses: z.boolean().optional(),
          liquidityTier: z.number().finite().optional(),
          includeSeeResults: z.boolean().optional(),
          pollType: z.enum(['single', 'multi-select', 'ranked-choice']).optional(),
