...
import { LabCard, LabSection } from 'web/pages/lab'
...
export const IsPoliticsAccurate = () => (
  <ExpandSection
    title={
      <>
  ...
  >
    ...
    .
    <br />
    We outperformed all real-money prediction markets and were in line with Nate
    Silver’s FiveThirtyEight’s performance when
    <a
      className="text-primary-700 hover:underline"
      target="_blank"
    ...
    .
    <br />
    Our biggest advantage is being able to apply this accuracy to a wider range
    of questions with real-time odds that instantly react to the news!
  </ExpandSection>
)

export const HowProbabilitiesGenerated = () => (
  <ExpandSection
    title={
      <>
        <FaPercentage className="mr-2" /> How are our probabilities generated
  ...
  >
    ...
    <br />
    It’s a little like combining the accuracy of sports betting and the stock
    market and applying it to predicting politics!
  </ExpandSection>
)
...
export const HowBet = () => (
  ...
  >
    All users start with free Mana (Ṁ$), the play-money used to bet on Manifold
    Politics.
    <br />
    You can use this to place bets. Earn more Mana by selling a bet early for a
    higher price than you bought or wait for it to conclude and win.
    <br />
    Mana can’t be redeemed for cash and is not crypto.
  </ExpandSection>
)

export const MakeOwnMarket = () => (
  <ExpandSection
    title={
      <>
        <TbGraph className="mr-2" /> Can I make my own questions/markets?
      </>
    }
  >
    ...
    , does allow you to make your own markets. You can make a question about
    anything you want to and have other users bet on it.
  </ExpandSection>
)
