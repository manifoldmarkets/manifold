...
function TopicAboutModalContent(props: {
...
export function TopicAboutSection(props: {
  group: Group
  canEdit: boolean
        ...
        <Row className="w-full items-center justify-between">
          ...
          <Row className="gap-2">
            ...
            <div className="relative">
              ...
              <div className="bg-highlight-blue absolute bottom-0 left-0 right-0 top-0 animate-pulse rounded bg-opacity-40" />
            </div>
          </Row>
        </Row>
        <Row className="w-full justify-end gap-2">
