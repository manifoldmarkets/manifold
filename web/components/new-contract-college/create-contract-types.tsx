...
export const PREDICTIVE_CONTRACT_TYPES = {
  ...
  //   example: 'Will Cornell accept a lower percentage in ED than last year?',
  //   visual: (
...
export const NON_PREDICTIVE_CONTRACT_TYPES = {
  ...
  //   example: `Recommend me some colleges with beautiful campuses, ${formatMoney(
  //     100
  ...
  //   example: `Which of HYPSM should be ranked number 1?`,
  //   visual: (
