...
export function MenuButton(props: {
  ...
  return (
    <Menu as="div" className={clsx('relative z-40 flex-shrink-0', className)}>
      ...
      >
        <Menu.Items className="absolute right-0 mt-2 w-40 origin-top-right rounded-md bg-white dark:bg-black py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
          {menuItems.map((item) => (
