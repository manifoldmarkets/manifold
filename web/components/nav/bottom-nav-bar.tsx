...
export function BottomNavBar() {
  ...
  return (
    <nav className="border-ink-200 dark:border-ink-300 text-ink-700 bg-canvas-0 fixed inset-x-0 bottom-[calc(env(safe-area-inset-bottom)-env(safe-area-max-inset-bottom))] z-50 flex select-none items-center justify-between border-t-2 pb-[env(safe-area-max-inset-bottom)] text-xs lg:hidden">
