...
import { createQuestion } from 'web/lib/firebase/api'
...
const useNewContract = (
  ...
  const resetProperties = () => {
    ...
    safeLocalStorage?.removeItem(`text create question`)
    setQuestion('')
  ...
  async function submit() {
    ...
    try {
      const newContract = (await createQuestion(
