...
export function ContractParamsForm(props: {
  ...
  const [addAnswersMode, setAddAnswersMode] = usePersistentLocalState<add_answers_mode>(
    params?.addAnswersMode ?? 'DISABLED',
    'new-add-answers-mode' + paramsKey
  )
  const [shouldAnswersSumToOne, setShouldAnswersSumToOne] = usePersistentLocalState(
