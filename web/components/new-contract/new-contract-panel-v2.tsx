...
export function NewContractPanelV2(props: {
  creator: User
  ...
  const getDefaultFormState = (): FormState => ({
    question: params?.q || '',
    outcomeType: (params?.outcomeType as any) || null, // Start with no type selected
  ...
  const descriptionEditor = useTextEditor({
    ...
    placeholder: 'Describe what the market is about...',
  })
      ...
      <Col className="mx-auto w-full max-w-3xl gap-6 p-6">
                ...
                <Row className="items-center gap-3">
                  ...
                  <span className="text-ink-600 text-xs">
                    {formState.shouldAnswersSumToOne
                      ...
                      : 'each answer can resolve YES or NO independently of other answers'}
                  </span>
                </Row>
              </Col>
        ...
        {formState.outcomeType && (
          <Row className="flex-wrap gap-2">
            ...
            {/* Description - Grey when blank, green when filled */}
            <button
              onClick={() => {
