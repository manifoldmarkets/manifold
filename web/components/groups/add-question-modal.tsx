...
import { SelectQuestions } from '../contract-select-modal'
...
export function AddQuestionToGroupModal(props: {
  group: Group
  user: User
  open: boolean
  setOpen: (open: boolean) => void
  onAddQuestions: (contracts: Contract[]) => void | Promise<void>
  addPermission: AddContractToGroupPermissionType
}) {
  const { group, user, open, setOpen, onAddQuestions, addPermission } = props
