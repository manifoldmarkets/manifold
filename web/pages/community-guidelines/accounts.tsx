    ...
    <Page trackPageView="community guidelines accounts page" className="!col-span-7">
      ...
      <Col className="mx-auto w-full max-w-5xl px-4 py-8">
        ...
        <div className="mt-6 rounded-xl border-2 border-ink-200 bg-canvas-0 p-6">
          <h2 className="text-xl font-semibold text-ink-900">General account rules</h2>
        ...
        <div className="mt-6 rounded-xl border-2 border-ink-200 bg-canvas-0 p-6">
          <h2 className="text-xl font-semibold text-ink-900">Alt accounts</h2>
          <ul className="mt-3 list-disc space-y-2 pl-5 text-ink-700">
            <li>Multiple accounts are allowed under specific conditions:</li>
            <li>Trading bots must submit a pull request for a bot tag.</li>
        ...
        <div className="mt-6 rounded-xl border-2 border-ink-200 bg-canvas-0 p-6">
          <h2 className="text-xl font-semibold text-ink-900">Market manipulation</h2>
        ...
        <div className="mt-6 rounded-xl border-2 border-ink-200 bg-canvas-0 p-6">
          <h2 className="text-xl font-semibold text-ink-900">Insider trading</h2>
