      ...
      <Col className="mx-auto w-full max-w-5xl px-4 py-8">
        ...
        <div className="mt-6 rounded-xl border-2 border-ink-200 bg-canvas-0 p-6">
          ...
          <ul className="mt-3 list-disc space-y-2 pl-5 text-ink-700">
            ...
            <li>Go above and beyond the guidelines without exploiting technicalities or oversights.</li>
            <li>Stay active on Manifold and check #mod-help in Discord regularly.</li>
            <li>Work collaboratively with the team and other mods.</li>
          </ul>
          <p className="mt-3 text-ink-700">Mod status can be removed and reinstated without it being a reflection on you personally. Reasons for removal include:</p>
          <ul className="mt-2 list-disc space-y-2 pl-5 text-ink-700">
            <li>Not wanting to do the work</li>
            <li>Extended inactivity</li>
            <li>Being consistently negative toward Manifold, staff, or users — we have high tolerance here and will warn first</li>
            ...
            <table className="w-full text-sm text-ink-700">
              ...
              <tbody className="divide-y divide-ink-100">
                <tr>
                  ...
                  <td className="py-2">Commenting, messaging, creating posts, adding answers, poll voting</td>
                </tr>
                <tr>
                  <td className="py-2 pr-6 font-medium">Market control</td>
                  <td className="py-2">Creating, editing, resolving markets, hiding comments, adding/editing answers, poll voting</td>
                </tr>
                <tr>
                  <td className="py-2 pr-6 font-medium">Trading</td>
                  <td className="py-2">Betting, managrams, liquidity changes, adding answers, boosting markets, poll voting</td>
                </tr>
              </tbody>
            </table>
          </div>
          <p className="mt-4 text-ink-700">When to use which:</p>
          <ul className="mt-2 list-disc space-y-2 pl-5 text-ink-700">
        ...
        <div className="mt-6 rounded-xl border-2 border-ink-200 bg-canvas-0 p-6">
          ...
          <ul className="mt-3 list-disc space-y-2 pl-5 text-ink-700">
            ...
            <li>Mods should only issue permanent bans for obvious spam. All other permanent bans go to admins.</li>
            <li>If someone is actively problematic, issue a warning first. If they escalate, contact the community manager. As a last resort, issue a temporary ban and make that clear to the user.</li>
            <li>Self-promotion by a genuine user is not spam unless posted across many unrelated markets in large quantities.</li>
          </ul>
        </div>
        ...
        <div className="mt-6 rounded-xl border-2 border-ink-200 bg-canvas-0 p-6">
          ...
          <ul className="mt-3 list-disc space-y-2 pl-5 text-ink-700">
            ...
            <li>Once dismissed, the alert no longer shows as active on the ban management page.</li>
          </ul>
        </div>
        ...
        <div className="mt-6 rounded-xl border-2 border-ink-200 bg-canvas-0 p-6">
          ...
          <ul className="mt-3 list-disc space-y-2 pl-5 text-ink-700">
            ...
            <li>There's an influx of activity or new events requiring criteria clarification</li>
            <li>The creator is unresponsive for at least 24 hours — use judgment if they're generally active or it's not urgent</li>
          </ul>
        </div>
        ...
        <div className="mt-6 rounded-xl border-2 border-ink-200 bg-canvas-0 p-6">
          ...
          <ol className="mt-3 list-decimal space-y-2 pl-5 text-ink-700">
            ...
            <li>Creator has 48 hours to return and override the new criteria.</li>
            <li>If they don't return, the mod runs the market from that point.</li>
            <li>If the creator returns and wants to reclaim the market, they need a good reason to modify the mod's criteria. If they hold a lot of shares and are trying to swing the market in their favor, you can deny them. Escalate to the community manager if needed.</li>
          </ol>
        </div>
        ...
        <div className="mt-6 rounded-xl border-2 border-ink-200 bg-canvas-0 p-6">
          ...
          <ul className="mt-2 list-disc space-y-2 pl-5 text-ink-700">
            <li>Markets by Tomek, NathanYoung, Gigacasting, the Manifold Markets account, and Manifold staff can be resolved as soon as criteria are met.</li>
            <li>If the creator is inactive, you may resolve.</li>
            <li>If the creator is active, ping them in a comment and resolve if no response after 1 day.</li>
          </ul>
          <p className="mt-3 text-ink-700 font-medium">If the close date has passed and resolution is ambiguous:</p>
          <ul className="mt-2 list-disc space-y-2 pl-5 text-ink-700">
            <li>Reopen the market if appropriate. Ask the creator if they're active.</li>
            <li>If criteria have technically been met but interpretation is unclear, try to get the creator to resolve first. Waiting a couple of months is fine given the loan system.</li>
            <li>If 3 out of 3 mods unanimously agree on the interpretation, you can resolve that way — roughly 1 week after close if the creator is inactive.</li>
            <li>Failing the above, resolve N/A.</li>
          </ul>
          <p className="mt-3 text-sm text-ink-600"><span className="font-medium">"Active" is defined as</span> any creator who has made a bet, comment, or market in the past 2 weeks.</p>
        </div>
        ...
        <div className="mt-6 rounded-xl border-2 border-ink-200 bg-canvas-0 p-6">
          ...
          <ul className="mt-2 list-disc space-y-2 pl-5 text-ink-700">
            ...
            <li>The creator resolved too early but in the right direction — don't force it back, ask them to unresolve and set a new close date. If they refuse, leave it and re-resolve later if events play out differently.</li>
            <li>The resolution is blatantly wrong by any reasonable reading — correct it and warn the creator.</li>
          </ul>
          <p className="mt-3 text-ink-700">Do not change a resolution when:</p>
          <ul className="mt-2 list-disc space-y-2 pl-5 text-ink-700">
            <li>It's defensible even if imperfect — comment suggestions but leave the final call to the creator.</li>
            <li>A creator is a large benefactor of an ambiguous resolution — give benefit of the doubt the first time with a warning, unless it's clearly fraudulent. Escalate repeat infractions.</li>
          </ul>
        </div>
        ...
        <div className="mt-6 rounded-xl border-2 border-ink-200 bg-canvas-0 p-6">
          ...
          <ul className="mt-3 list-disc space-y-2 pl-5 text-ink-700">
            ...
            <li>Any situation that's unique, unclear, or getting significant blowback from creators or users.</li>
