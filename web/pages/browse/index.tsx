...
export function BrowsePageContent() {
  ...
  // Fetch hot topics by importance score - don't prioritize user's followed topics
  // to surface news-related topics they haven't seen before
  const trendingTopics = useTrendingTopics(
    50,
    'home-page-trending-topics'
  ) as Group[]

  const initialTopics = (trendingTopics ?? []).filter(
    (t) => !EXCLUDED_TOPIC_SLUGS.includes(t.slug)
  )
