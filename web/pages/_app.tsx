...
function MyApp({ Component, pageProps }: AppProps<ManifoldPageProps>) {
  ...
  const title = 'SAGE'
  const description = `SAGE is a social prediction game. ${capitalize(
    TRADE_TERM
  ...
  return (
    <>
      ...
      {/* Umami, for pageview analytics on https://analytics.umami.is/share/ARwUIC9GWLNyowjq/SAGE%20Markets */}
      <Script
