...
create table if not exists
  user_contract_views (
    ...
    promoted_views bigint default 0 not null,
    card_views bigint default 0 not null,
    ...
    constraint user_contract_views_card_views_check check ((card_views >= 0)),
    ...
    constraint user_contract_views_page_views_check check ((page_views >= 0)),
