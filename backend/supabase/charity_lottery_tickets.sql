...
-- Foreign Keys
alter table charity_lottery_tickets
add constraint charity_lottery_tickets_lottery_num_fkey foreign key (lottery_num) references charity_lotteries (lottery_num);
