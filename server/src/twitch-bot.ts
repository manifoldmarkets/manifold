...
const MSG_SIGNUP = (username: string) => `Hello ${username}! Hey guys, click here to play: ${signupLink}!`;
...
export default class TwitchBot {
    ...
    constructor(app: App) {
        ...
        this.client.on("connected", () => {
            ...
            this.client.say(channel, "/clear");
            this.client.say(channel, "/color BlueViolet");
        });
    }
    ...
    joinChannel(channelName: string) {
        ...
        this.client.join(channelName).then(() => {
            // this.client.say(channelName, "/clear");
